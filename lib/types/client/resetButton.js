...
export function ResetButton(props) {
    ...
    return (_jsx("button", { type: "button", title: title, "aria-label": title, onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), onClick: () => { onClick(); }, style: busy ? busyStyle : (hover ? hoverStyle : idleStyle), children: _jsx(IconRefreshOutline16, {}) }));
}
