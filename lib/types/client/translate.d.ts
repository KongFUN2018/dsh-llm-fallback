 ...
 */
export declare function bindFallbackTranslate(t: TranslateNS<'llmFallback'>): void;
/**
 ...
 */
export declare function fbT(key: Parameters<TranslateNS<'llmFallback'>>[0], params?: Record<string, string | number>): string;
